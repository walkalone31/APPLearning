...
import com.example.appstart1.ExpandableListAdapter;
import com.example.appstart1.ScannedData;
import com.example.appstart1.ServiceInfo;
import com.example.appstart1.BluetoothLeService;
...
public class DeviceInfoActivity extends AppCompatActivity implements ExpandableListAdapter.OnChildClick {
    ...
    private TextView tvAddress,tvStatus,tvRespond,tvDeviceName;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        System.out.printf("- DeviceInfoActivity rrrrrrrrrrrrrrrrrr\n");
    ...
    private void initUI(){
        ...
        tvRespond.setText("---");
        tvDeviceName.setText(selectedDevice.getDeviceName());
    }
    /**藍芽已連接/已斷線資訊回傳*/
